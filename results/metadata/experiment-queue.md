...
- [x] **#2** `src/ApplicationCore/Specifications/CatalogFilterPaginatedSpecification.cs` — Add AsNoTracking to read-only paginated catalog specification *(experiment 8 — improved)*
