...
## Runtime Counters
- CPU avg: 0.59%
- GC heap max: 164.34MB
- Gen2 collections: 5908376
- Thread pool max threads: 14
...
- [TRIED] `src/PublicApi/CatalogItemEndpoints/CatalogItemListPagedEndpoint.cs` — Eliminate AutoMapper overhead and inefficient PageCount calculation in list endpoint *(experiment 7 — stale)*
- [TRIED] `src/ApplicationCore/Specifications/CatalogFilterPaginatedSpecification.cs` — Add AsNoTracking to read-only paginated catalog specification *(experiment 8 — improved)*
- [TRIED] `src/PublicApi/CatalogItemEndpoints/UpdateCatalogItemEndpoint.cs` — Skip redundant fetch in update by using direct entity attach pattern *(experiment 9 — skipped)*
...
| 4 | — | stale | 2.2 | 341 | hone/experiment-4 |
| 5 | — | improved | 1.8 | 341.7 | hone/experiment-5 |
| 6 | — | stale | 1.8 | 341.1 | hone/experiment-6 |
| 7 | — | stale | 2 | 341 | hone/experiment-7 |
| 8 | — | improved | 1.8 | 341.7 | hone/experiment-8 |
| 9 | — | no_queue_items | N/A | N/A | — |
