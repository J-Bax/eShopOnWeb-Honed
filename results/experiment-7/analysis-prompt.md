...
## Runtime Counters
- CPU avg: 0.58%
- GC heap max: 167.61MB
- Gen2 collections: 5914880
...
- [TRIED] `src/PublicApi/CatalogBrandEndpoints/CatalogBrandListEndpoint.cs` — Cache static catalog brands in memory *(experiment 4 — stale)*
- [TRIED] `src/PublicApi/CatalogTypeEndpoints/CatalogTypeListEndpoint.cs` — Cache static catalog types in memory *(experiment 5 — improved)*
- [TRIED] `src/PublicApi/CatalogItemEndpoints/CreateCatalogItemEndpoint.cs` — Replace CountAsync with AnyAsync for duplicate check *(experiment 6 — stale)*
