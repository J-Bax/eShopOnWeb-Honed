...
public class K6CleanupEndpoint : IEndpoint<IResult, K6CatalogStateRequest, K6CatalogStateService>
{
    public void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("diag/k6/cleanup",
    ...
    public async Task<IResult> HandleAsync(K6CatalogStateRequest request, K6CatalogStateService k6CatalogStateService)
    {
        ...
        var response = await k6CatalogStateService.CleanupAsync(request);
